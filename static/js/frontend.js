...
const showReport = () => {
    ...
    var REST_CALL = "http://127.0.0.1:8885/get-report";
...
const getData = () => {
    ...
    var REST_CALL = "http://127.0.0.1:8885/get-current-activity";
    ...
    const setImgData = (apidata) => {
        ...
        for (var key of Object.keys(apidata.current_activity)) {
            ...
            var col1 = key;
            tbl.rows[0].style.backgroundColor = "#ADD8E6";
            try {
                tbl.rows[0].style.font="bold";
                tbl.rows[1].style.backgroundColor = "#228B22";
                if ((x==="falling")||(x==="pain/cough")){        
                    tbl.rows[1].style.backgroundColor = "#D22B2B";
                }
            }
            catch(err) {
...
$('form').submit(function (e) {
    ...
    var REST_CALL = "http://127.0.0.1:8885/upload-video"
